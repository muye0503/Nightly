...
def main():
	...
	parse.add_argument('-l', '--log', help='rerun log path', dest='log', required=True)
	parse.add_argument('-p', '--plan', help='test plan', dest='plan', required=True)
	parse.add_argument('-w', '--workspace', help='workspace', dest='workspace', required=True)
	parse.add_argument('-d', '--dvd', help='dvd', dest='dvd', required=True)
